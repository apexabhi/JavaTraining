	...
	<form action="edit" method="post">
		<div class="mb-3">
			...
			<input type="text" class="form-control" name="bookcode"
				id="bookcode" readonly="readonly" value="<%= request.getParameter("id") %>">
		</div>
		<div class="mb-3">
			<label for="bookname" class="form-label">Book Name</label>
			<input type="text" class="form-control" name="bookname"
				id="bookname" value="<%= request.getParameter("name") %>">
		</div>
		<div class="mb-3">
			<label for="author" class="col-12 col-md-2 form-label">Author</label> 
			  <select class="col-12 col-md-5 form-control" name="author" id="author" required>
				...
				%>
				<option value="<%= request.getParameter("author") %>" selected><%= request.getParameter("author") %></option>
